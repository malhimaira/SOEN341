...
public class TestParser {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("[halt 0 row:1 column:1, and D row:2 column:1, shl 18 row:3 column:1, tgt 1D row:4 column:1, exit 3 row:5 column:1, ldc.i3 95 row:6 column:1, enter.u5 8F row:7 column:1 ;Test Comment, ;Comment and no Instruction]");
