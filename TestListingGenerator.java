...
public class TestListingGenerator {
    ...
    stubIR.add(new LineStatement(new Instruction(new Mnemonic("or",false,new Position(6,0)))));
    stubIR.add(new LineStatement(new Instruction(new Mnemonic("xor",false,new Position(7,0)))));
    stubIR.add(new LineStatement(new Instruction(new Mnemonic("neg",false,new Position(8,0)))));
