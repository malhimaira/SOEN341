...
public class CMA {
	...
	public static void main(String[] args) {
		...
		IIR IR =  parser.parse();
	        ...
	        CodeGenerator cg = new CodeGenerator(IR, fileName, st, lt, optionUser.getListingStatus()); //Set to true for now since we always want the listing file for sprint 2
